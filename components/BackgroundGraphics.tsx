    ...
    >
      ...
      >
        ...
        <g className="transition-all duration-1200" style={{ transformBox: 'fill-box' }}>
          <g style={{ transformBox: 'fill-box', transform: 'translate(calc(var(--mouseXdelta) * 5%), calc(var(--mouseYdelta) * 5% - var(--scrollYDelta) * 400%))' }}>
        ...
        <g className="transition-all duration-1200" style={{ transformBox: 'fill-box' }}>
          <g style={{ transformBox: 'fill-box', transform: 'translate(calc(var(--mouseXdelta) * 7.5%), calc(var(--mouseYdelta) * 7.5% - var(--scrollYDelta) * 400%))' }}>
        ...
        <g className="transition-all duration-1200" style={{ transformBox: 'fill-box' }}>
          <g style={{ transformBox: 'fill-box', transform: 'translate(calc(var(--mouseXdelta) * 6%), calc(var(--mouseYdelta) * 6% - var(--scrollYDelta) * 400%))' }}>
        ...
        <g className="transition-all duration-1200" style={{ transformBox: 'fill-box' }}>
          <g style={{ transformBox: 'fill-box', transform: 'translate(calc(var(--mouseXdelta) * 8.5%), calc(var(--mouseYdelta) * 8.5% - var(--scrollYDelta) * 400%))' }}>
        ...
        <g className="transition-all duration-1200" style={{ transformBox: 'fill-box' }}>
          <g style={{ transformBox: 'fill-box', transform: 'translate(calc(var(--mouseXdelta) * 4%), calc(var(--mouseYdelta) * 4% - var(--scrollYDelta) * 400%))' }}>
        ...
        <g className="transition-all duration-1200" style={{ transformBox: 'fill-box' }}>
          <g style={{ transformBox: 'fill-box', transform: 'translate(calc(var(--mouseXdelta) * 9%), calc(var(--mouseYdelta) * 9% - var(--scrollYDelta) * 400%))' }}>
        ...
        <g className="transition-all duration-1200" style={{ transformBox: 'fill-box' }}>
          <g style={{ transformBox: 'fill-box', transform: 'translate(calc(var(--mouseXdelta) * 5.5%), calc(var(--mouseYdelta) * 5.5% - var(--scrollYDelta) * 400%))' }}>
        ...
        <g className="transition-all duration-1200" style={{ transformBox: 'fill-box' }}>
          <g style={{ transformBox: 'fill-box', transform: 'translate(calc(var(--mouseXdelta) * 7%), calc(var(--mouseYdelta) * 7% - var(--scrollYDelta) * 400%))' }}>
        ...
        <g className="transition-all duration-1200" style={{ transformBox: 'fill-box' }}>
          <g style={{ transformBox: 'fill-box', transform: 'translate(calc(var(--mouseXdelta) * 10%), calc(var(--mouseYdelta) * 10% - var(--scrollYDelta) * 400%))' }}>
        ...
        <g className="transition-all duration-1200" style={{ transformBox: 'fill-box' }}>
          <g style={{ transformBox: 'fill-box', transform: 'translate(calc(var(--mouseXdelta) * 6.5%), calc(var(--mouseYdelta) * 6.5% - var(--scrollYDelta) * 400%))' }}>
        ...
        <g className="transition-all duration-1200" style={{ transformBox: 'fill-box' }}>
          <g style={{ transformBox: 'fill-box', transform: 'translate(calc(var(--mouseXdelta) * 8%), calc(var(--mouseYdelta) * 8% - var(--scrollYDelta) * 400%))' }}>
        ...
        <g className="transition-all duration-1200" style={{ transformBox: 'fill-box' }}>
          <g style={{ transformBox: 'fill-box', transform: 'translate(calc(var(--mouseXdelta) * 4.5%), calc(var(--mouseYdelta) * 4.5% - var(--scrollYDelta) * 400%))' }}>
        ...
        <g className="transition-all duration-1200" style={{ transformBox: 'fill-box' }}>
          <g style={{ transformBox: 'fill-box', transform: 'translate(calc(var(--mouseXdelta) * 9.5%), calc(var(--mouseYdelta) * 9.5% - var(--scrollYDelta) * 400%))' }}>
