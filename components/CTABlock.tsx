      ...
      <div className="max-w-maxw mx-auto px-container py-24 space-y-8 relative z-10">
        <div className="lg:flex">
          ...
          <div className="space-y-8">
            ...
            <div className="md:flex gap-12 mt-16 h-16 lg:h-25">
              <svg width="104" height="92" viewBox="0 0 104 92" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-auto h-full">
