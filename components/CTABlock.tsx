    ...
    <div ref={containerRef} className="bg-qreen text-qaupe relative my-16 md:my-25">
      ...
      <div className="max-w-maxw mx-auto px-container py-24 space-y-8 relative z-10">
        <div className="lg:flex">
          <h2 className="lg:basis-36 uppercase tracking-[0.04em]">Membership</h2>
          <div className="space-y-8">
            <p className="text-2xl md:text-[2.375rem] tracking-[-0.07125rem] leading-none">
              You want to <span className="text-qlack">develop.</span>
              <br />
              You want to <span className="text-qlack">be recognised.</span>
              <br />
              You want to <span className="text-qlack">feel inspired.</span>
              <br />
              You want to <span className="text-qlack">connect.</span>
            </p>
            <div className="flex gap-3 md:gap-12 mt-16 h-16 lg:h-25">
              <svg 
                width="104" height="92" 
                viewBox="0 0 104 92" fill="none" 
                xmlns="http://www.w3.org/2000/svg" 
                className="w-auto h-12 md:h-full"
              >
