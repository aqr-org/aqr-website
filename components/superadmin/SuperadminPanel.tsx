...
export default function SuperadminPanel() {
  ...
  // Directory Search Criteria state
              ...
              {isLoadingAreas ? (
                ...
                <div className="space-y-8">
                  {Object.entries(areasByCategory).map(([category, areas]) => (
                    <div key={category} className="p-4 bg-white/50 rounded-lg border border-qlack/20">
                      <h3 className="text-xl font-semibold mb-4">{category}</h3>
                      
                      {/* Add New Area Form */}
                      <div className="mb-6 p-4 bg-white/80 rounded-lg border border-qlack/20">
                      ...
                      {/* Existing Areas List */}
                      <div>
                        <h4 className="text-lg font-medium mb-3">Existing Areas ({areas.length})</h4>
                        {areas.length === 0 ? (
                          ...
                          <div className="space-y-2">
                            {areas.map((area) => {
                              ...
                              return (
                                <div
                                  key={area.id}
                                  className="p-3 bg-white/80 rounded-lg border border-qlack/20 flex items-center gap-4"
                                >
                                  <div className="flex-1">
                                    {isEditing ? (
                                      ...
                                      <p className="text-base text-qlack">{area.area}</p>
                                    )}
                                  </div>
                                  {!isEditing && (
                                    <div className="flex gap-2">
