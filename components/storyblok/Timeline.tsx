...
export default function Timeline({ blok }: TimelineProps) {
  ...
  return (
    <div
      ...
      className={cn(
        "w-[calc(100%+var(--spacing-container))] md:w-[calc(100vw*0.7+var(--spacing-container))] xl:w-[calc(var(--container-maxw)*0.666+var(--spacing-container))] overflow-visible relative"
      )}
    >
