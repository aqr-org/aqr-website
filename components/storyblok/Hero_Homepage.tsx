    ...
    <div className='absolute inset-0 -z-10'>
      ...
      >
        ...
        <path 
          style={{
            transformBox: 'fill-box',
            transform: 'translate(calc(var(--mouseXdelta) * 15%), calc(var(--mouseYdelta) * 15%))'
          }}
        ...
        <path 
          ...
          style={{
            transformBox: 'fill-box',
            transform: 'translate(calc(var(--mouseXdelta) * 20%), calc(var(--mouseYdelta) * 20%))'
          }}
        ...
        <g
          ...
          style={{
            transformBox: 'fill-box',
            transform: 'translate(calc(var(--mouseXdelta) * 12%), calc(var(--mouseYdelta) * 12%))'
          }}
        >
          <path 
