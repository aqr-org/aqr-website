...
return (
    ...
    {blok.intro && 
      <div className='relative mt-10 md:ml-[10%] max-w-[36rem]'>
        ...
        <div className='absolute bottom-1/4 left-full w-[15vw]'>
