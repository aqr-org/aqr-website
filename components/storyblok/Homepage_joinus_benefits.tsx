        ...
        <div className='lg:pr-36'>
          <p className='text-5xl hyphens-auto md:hyphens-manual md:text-6xl lg:text-[6.25rem] tracking-[-0.1875rem] leading-[0.95]'>
            <Link href={normalizeStoryblokUrl(blok.link.cached_url)} className='group inline-block relative hover:text-qreen-dark no-underline!'>
              Join AQR, 
              <svg 
                className="absolute top-[calc(100%-0.5rem)] md:top-[calc(100%-0.25rem)] left-0 w-full group-hover:scale-x-0
              ...
              <svg 
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[110%] opacity-0 group-hover:opacity-100 scale-90 group-hover:scale-100 transition-all duration-300"
