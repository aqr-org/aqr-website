...
export default async function FeatureCards({ 
  ...
  cards.push({
    ...
    content: (
      <div className="@container w-full h-full text-left space-y-2 text-qaupe text-sm @[300px]:text-[1.375rem] leading-[0.8] flex flex-col items-center justify-center">
        ...
        <p>You want to <span className='text-qlack'>feel inspired.</span></p>
  ...
  return (
    <div {...storyblokEditable(blok)} className="w-full max-w-maxw mx-auto px-container py-18 overflow-hidden" style={{
