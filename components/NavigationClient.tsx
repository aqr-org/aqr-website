  ...
  return (
    <>
      <nav 
        className={cn(
          isScrolled ? 
          '-translate-y-full sticky top-0 z-60 w-full flex justify-center bg-qaupe transition-all duration-500 ease-in-out' 
          : 
          'sticky translate-y-0 top-0 z-60 w-full flex justify-center bg-qaupe transition-all duration-500 ease-in-out'
        )} 
